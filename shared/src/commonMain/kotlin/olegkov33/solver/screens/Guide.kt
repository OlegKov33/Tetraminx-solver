...
class Guide {
    // show a new window explaining how things work
    @Composable
        ...
        return Column{
            ...
            Column(Modifier.verticalScroll(rememberScrollState())) {
                Column(Modifier.padding(16.dp)){
                    ...
                    Text("You can always come back to this page by pressing \"?\" button" +
                ...
                Column(Modifier.padding(16.dp)){
                    ...
                    Text("Once you exit this page, you will see a tetra-minx model or at least 4 hexagons with 6 slices in each." +
                ...
                Column(Modifier.padding(16.dp)){
                    ...
                    Text("1. Pick which side will be your \"Front\" and enter its colors\n" +
                ...
                Column(Modifier.padding(16.dp)) {
                    ...
                    Text("Every color has 2 versions. If you find it difficult to use top or bottom color" +
